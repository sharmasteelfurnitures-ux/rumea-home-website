    ...
    <section className="py-16 sm:py-20 md:py-24 bg-[#F7F5F0]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <Link
            href="/products"
            className="group inline-flex items-center gap-1.5 text-xs sm:text-sm font-medium text-[#1E1E1B] hover:text-[#8A684A] transition-colors self-start sm:self-auto"
          >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6">
          {categories.map((cat, idx) => (
            ...
            >
              ...
              >
                {/* Image Frame */}
                <div className="relative aspect-[4/5] w-full rounded-xl overflow-hidden bg-[#EBE7DF] border border-[#DEDAD1] shadow-2xs group-hover:border-[#1E1E1B]/30 group-hover:shadow-sm transition-all duration-300">
                  <Image
                    src={cat.image}
                    alt={cat.name}
                    fill
                ...
                <div className="mt-3 text-left">
                  <h3 className="font-sans font-medium text-xs sm:text-sm text-[#1E1E1B] group-hover:text-[#8A684A] transition-colors leading-snug">
                    {cat.name}
                  </h3>
                  <span className="inline-flex items-center gap-1 text-[11px] sm:text-xs font-medium text-[#6B6962] group-hover:text-[#1E1E1B] transition-colors mt-1">
                    <span>Explore</span>
