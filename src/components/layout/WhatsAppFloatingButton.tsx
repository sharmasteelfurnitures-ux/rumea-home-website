  ...
  return (
    <aside aria-label="WhatsApp" className="fixed bottom-6 right-6 z-50 flex items-center group">
      ...
      <a
        ...
        onClick={handleClick}
        className="w-13 h-13 sm:w-14 sm:h-14 bg-[#2C2926] text-[#F7F4EE] rounded-full flex items-center justify-center shadow-[0_4px_16px_rgba(44,41,38,0.25)] hover:bg-[#48563A] hover:scale-105 active:scale-95 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#48563A]"
