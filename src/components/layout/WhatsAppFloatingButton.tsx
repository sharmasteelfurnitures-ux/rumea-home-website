  ...
  return (
    <aside aria-label="WhatsApp" className="fixed bottom-6 right-6 z-50 flex items-center group">
      ...
      <a
        ...
        onClick={handleClick}
        className="w-13 h-13 sm:w-14 sm:h-14 bg-[#78806A] text-white rounded-full flex items-center justify-center shadow-lg hover:bg-[#68705B] hover:scale-105 active:scale-95 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#78806A]"
      ...
      >
        ...
        <span className="absolute top-0 right-0 w-3.5 h-3.5 bg-espresso rounded-full border-2 border-white flex items-center justify-center">
          <span className="w-1.5 h-1.5 bg-[#A8B298] rounded-full animate-ping" />
        </span>
      </a>
    </aside>
  );
