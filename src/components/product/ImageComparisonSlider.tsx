...
export default function ImageComparisonSlider() {
  ...
  const comparisonModes: ComparisonMode[] = [
    {
      id: 'finishes',
      title: 'Finish & Surface Comparison',
      icon: Trees,
      leftLabel: 'Warm Honey Woodgrain',
      rightLabel: 'Matte Industrial Black',
      ...
      leftTag: 'Melamine Laminate',
      rightTag: 'Powder-Coated Steel',
      description: 'Compare durable laminate woodgrain finishes against scratch-resistant matte powder-coated steel.',
    },
    {
      id: 'ambience',
      ...
      leftTag: 'Direct Daylight',
      rightTag: 'Warm 2700K Lamp Glow',
      description: 'See how clean compact furniture lines and neutral tones adapt to bright morning light vs cozy evening lighting.',
    },
    {
      id: 'craft',
      title: 'Steel Structure vs. Assembled',
      icon: Layers,
      leftLabel: 'Heavy-Duty Steel Skeleton',
      rightLabel: 'Finished Product',
      ...
      leftTag: 'Reinforced Steel Frame',
      rightTag: 'Compact Domestic Unit',
      description: 'Slide to inspect the inner reinforced load-tested steel frame vs the clean finished exterior.',
    },
  ];
